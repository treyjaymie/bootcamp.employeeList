...
public class EmployeeDAO {
    private static final String SELECT_ALL_EMPLOYEES = "SELECT emp.employee_id, emp.first_name, emp.last_name, emp.email, emp.salary, emp.department_id, dept.department_name, emp.job_id"
    												+ " FROM employees emp , departments dept"
    												+ " WHERE emp.department_id = dept.department_id ";
    												// Lab Assignment: include deptarment_id, department_name, job_id
    ...
    public List<Employee> findBySalary(float minimumSalary, float maximumSalary) {
        ...
        try {
            ...
            // Take the place where the ? are in the Strings
